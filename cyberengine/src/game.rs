//! Game entry point, window creation, UI, and stuff.
...
pub trait Playable {
    fn new() -> Self;
    fn run(&mut self, title: String, clear_color: [f32; 4]) {
        use gfx::{self, Device};
    ...
    fn load(&mut self, factory: &mut graphics::Factory) -> ();
    fn tick(&mut self, ui: &Ui, dt: f32) -> ();
    fn render(
        &mut self,
        &mut graphics::Factory,
        &mut gfx::Encoder<graphics::Resources, graphics::CBuffer>,
